...
var songs = [
  {title: "Congratulations", artist: "Mac Miller", notes: [
    {delay: 0, note: "2", length: 3},
    {delay: 3, note: "3", length: 2},
    {delay: 5, note: "5", length: 1},
    {delay: 6, note: "2", length: 3},
    {delay: 9, note: "3", length: 2},
    {delay: 11, note: "5", length: 1},
  ]},
...
function App() {
  ...
  window.addEventListener("load", () => {
    ...
    document.addEventListener("keydown", (e) => {if (e.repeat) return; if (allKeys[e.keyCode] && typeof allKeys[e.keyCode].pianoKey !== "undefined" && tempMode === "piano") {allKeys[e.keyCode].pianoKey.classList.add("pressed"); allKeys[e.keyCode].pianoAudio.currentTime = 0; allKeys[e.keyCode].pianoAudio.play();}});
    document.addEventListener("keyup", (e) => {if (allKeys[e.keyCode] && typeof allKeys[e.keyCode].pianoKey !== "undefined" && tempMode === "piano") allKeys[e.keyCode].pianoKey.classList.remove("pressed");});
  ...
  useEffect(() => {
    ...
    if (song !== null){
      ...
      console.log(pianoHolder.getBoundingClientRect().width);
      ...
      song.notes.forEach((e, i) => {
        ...
        pianoNotes.current.classList.add("end");

      })

      console.log(pianoHolder.getBoundingClientRect());
      ...
      <div className={`page${mode === "piano" ? " visible" : ""}`}>
        ...
        <div className="piano-holder">
          ...
          <div className={`song-details${song !== null ? " visible" : ""}`}>
            <div className="song-title">{song !== null ? song.title : ":-D"}</div>
